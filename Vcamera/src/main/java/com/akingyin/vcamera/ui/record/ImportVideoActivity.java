...
public class ImportVideoActivity extends BaseActivity
		implements OnClickListener, OnPreparedListener, VideoView.OnPlayStateListener {
		...
		if (!isFinishing() && mMediaObject != null && mMediaPart != null) {
			new AsyncTask<Integer, Void, Boolean>() {
				...
				@Override protected Boolean doInBackground(Integer... params) {
				 return FFMpegUtils.importVideo(mMediaPart, mWindowWidth, params[0], params[1], 0, 0, true);
				}
			...
			}.execute(mVideoView.getVideoWidth(),mVideoView.getVideoHeight());
		}
	}
