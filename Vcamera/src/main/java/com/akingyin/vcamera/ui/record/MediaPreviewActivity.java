...
import com.akingyin.vcamera.media.MediaPlayer;
import com.akingyin.vcamera.ui.BaseActivity;
import com.akingyin.vcamera.ui.record.views.FrameImageView;
import com.akingyin.vcamera.ui.widget.VideoView;
import com.akingyin.vcamera.utils.IsUtils;
import com.akingyin.vcamera.utils.ResourceUtils;
import java.io.File;
...
public class MediaPreviewActivity extends BaseActivity
		implements OnClickListener, VideoView.OnPlayStateListener, OnPreparedListener {
	...
	public void onClick(View v) {
		...
		} else if (i == R.id.record_preview_theme_original) {
			loadTheme(null);
		} else if (i == R.id.record_preview_theme_news) {
			loadTheme("News");
		} else if (i == R.id.record_preview_theme_goddess) {
			loadTheme("Goddess");
		} else if (i == R.id.record_preview_theme_recording) {
			loadTheme("Recording");
		} else if (i == R.id.record_preview_theme_bsmall) {
			loadTheme("Bsmall");
