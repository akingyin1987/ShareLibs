 ...
 */
package com.zlcdgroup.libs.Provider.base;
...
public abstract class BaseContentProvider extends ContentProvider {
    ...
    protected abstract SQLiteDatabase createSqLiteOpenHelper();

    protected SQLiteDatabase mSqLiteOpenHelper;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mSqLiteOpenHelper.insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mSqLiteOpenHelper;
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mSqLiteOpenHelper.update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mSqLiteOpenHelper.delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
       ...
       // projection = ensureIdIsFullyQualified(projection, queryParams.table, queryParams.idColumn);
        System.out.println("select=="+(null == selection)+":"+queryParams.selection+":"+queryParams.orderBy+":"+queryParams.idColumn);
        Cursor res = mSqLiteOpenHelper.query(queryParams.table, projection, queryParams.selection, selectionArgs, groupBy,
