 ...
 * @ Author king
 * @ Date 2016/9/23 17:41
 * @ Version V1.0
 */

public class CameraComponent   extends  CameraComponentBase  implements
   ...
   *
   */
  @Override public void onTuCameraFragmentCaptured(TuCameraFragment tuCameraFragment,
   ...
   */
  @Override public boolean onTuCameraFragmentCapturedAsync(TuCameraFragment tuCameraFragment,
      TuSdkResult tuSdkResult) {
    return false;
  }
   ...
   *            系统相册控制器
   */
  @Override public void onTuAlbumDemand(TuCameraFragment tuCameraFragment) {
   ...
   * @return
   */
  public TuSdkWaterMarkOption getWaterMarkOption(AppCompatActivity activity)
  {
