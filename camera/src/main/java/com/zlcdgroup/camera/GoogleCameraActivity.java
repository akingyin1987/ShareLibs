    ...
    public void onClick(View v) {
      ...
      if (i == R.id.tack_camera) {
        if (ContextCompat.checkSelfPermission(GoogleCameraActivity.this,
          ...
          ConfirmationDialogFragment.newInstance(R.string.storage_permission_confirmation,
              new String[] { Manifest.permission.WRITE_EXTERNAL_STORAGE },
              REQUEST_STORAGE_PERMISSION, R.string.storage_permission_not_granted)
              .show(getSupportFragmentManager(), FRAGMENT_DIALOG);
        } else {
          ActivityCompat.requestPermissions(GoogleCameraActivity.this,
              new String[] { Manifest.permission.WRITE_EXTERNAL_STORAGE },
